...
<main>
    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="{{url('dashboard/buat-kiriman')}}">Kiriman</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="head-title">
        <a href="{{route('buat-kiriman.create')}}" class="btn-download">
            <span class="text">Buat Kiriman Baru</span>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ url('dashboard/buat-kiriman/'.$item['id_kirim']) }}" type="button" class="status process">Edit</a>
                                <form action="{{ url('dashboard/buat-kiriman/'.$item['id_kirim']) }}" method="post" onsubmit="return confirm('Apakah yakin akan melakukan penghapusan data?')" class="d-inline">
                                    @csrf
                                    @method('delete')
